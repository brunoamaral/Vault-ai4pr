...
## Definition
LLM (Large Language Model) is an [AI](Artificial%20intelligence%20(AI).md) model trained on vast text data to generate, understand, and manipulate natural language.
...
One caveat of LLMs is their possibility to hallucinate, creating output that is not true.[^1]
...
[^1]: View [Hallucination](Hallucination.md)
