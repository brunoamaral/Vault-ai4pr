...
## Definition
GPT (Generative Pre-trained Transformer) is a term used by [OpenAI](OpenAI.md). Like an [LLM](Large%20language%20model%20(LLM).md), it is AI model that generates human-like text by understanding context from large datasets.
...
## Sources
1. Radford, A., Narasimhan, K., Salimans, T., & Sutskever, I. (2018). Improving language understanding by generative pre-training. [OpenAI](OpenAI.md). https://doi.org/10.48550/arXiv.1801.06146 
